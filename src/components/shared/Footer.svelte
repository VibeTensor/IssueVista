...
<footer class="footer" aria-label="Site footer">
  <div class="footer-row">
    ...
    <div class="brand-center">
      ...
      <a href={COMPANY_GITHUB} target="_blank" rel="noopener noreferrer" class="company">{COMPANY_SHORT}</a>
    </div>
    ...
    <div class="share-right">
      ...
      {/if}
      <a href={getTwitterShareUrl()} target="_blank" rel="noopener noreferrer" class="share-btn" aria-label="Share on X">
        <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
        </svg>
      </a>
      <a href={getLinkedInShareUrl()} target="_blank" rel="noopener noreferrer" class="share-btn" aria-label="Share on LinkedIn">
        <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
