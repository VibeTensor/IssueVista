  ...
  <div class="footer-inner">
    ...
    <div class="footer-top">
      <div class="footer-brand">
        ...
        <a href={COMPANY_GITHUB} target="_blank" rel="noopener noreferrer" class="company-link">{COMPANY_SHORT}</a>
      </div>
      ...
      <div class="footer-social">
        ...
        {/if}
        <a href={getTwitterShareUrl()} target="_blank" rel="noopener noreferrer" class="social-btn" aria-label="Share on X">
          <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
          </svg>
        </a>
        <a href={getLinkedInShareUrl()} target="_blank" rel="noopener noreferrer" class="social-btn" aria-label="Share on LinkedIn">
          <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div class="footer-bottom">
      <nav class="footer-links" aria-label="Footer navigation">
        ...
        <a href={CONTRIBUTING_URL} target="_blank" rel="noopener noreferrer" class="footer-link">Contribute</a>
