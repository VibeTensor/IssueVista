<!--
  ...
  Uses portal pattern to render modal at document body for proper centering.
-->
...
<script lang="ts">
  ...
  // Portal effect: move modal to document body when shown
  $effect(() => {
...
<!-- Portal container for modal - will be moved to document.body -->
{#if show}
  <div bind:this={portalContainer} class="filter-help-portal">
